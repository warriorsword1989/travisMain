...
angular.module('app').controller('taskRefineTableCtrl', ['$scope', 'ngDialog', 'dsManage', 'dsFcc', '$timeout', 'dsColumn', 'appPath', 'dsEdit',
        ...
        function initTaskTable() {
            $scope.gridOptions = {
                ...
                columnDefs: [{
                    ...
                    enableSorting: true,
                    visible: true,
                    cellTemplate: '<div class="ui-grid-cell-contents"><div class="task-underline-blue" ng-click="grid.appScope.selectSubTask(row.entity)">{{row.entity.name}}</div></div>'
                }, {
                    field: 'subtaskId',
                    displayName: '子任务ID',
                    minWidth: 70,
                    enableSorting: true,
                    visible: true,
                    cellTemplate: '<div class="ui-grid-cell-contents"><div class="task-underline-blue" ng-click="grid.appScope.selectSubTask(row.entity)">{{row.entity.subtaskId}}</div></div>'
                }, {
                    field: 'isQuality',
                    displayName: '环节',
                    enableSorting: true,
                    ...
                    visible: true,
                    enableSorting: true,
                    cellTemplate: '<div class="ui-grid-cell-contents"><span>{{row.entity.pointWaitWork? row.entity.pointWaitWork : "无"}}</span></div>'
                }, {
                    field: 'pointWorked',
                    displayName: '待提交点门牌',
                    minWidth: 70,
                    visible: true,
                    enableSorting: true,
                    cellTemplate: '<div class="ui-grid-cell-contents"><span>{{row.entity.pointWorked? row.entity.pointWorked : "无"}}</span></div>'
                }, {
                    field: 'pointCommit',
                    displayName: '已提交点门牌',
                    minWidth: 70,
                    visible: true,
                    enableSorting: true,
                    cellTemplate: '<div class="ui-grid-cell-contents"><span>{{row.entity.pointCommit? row.entity.pointCommit : "无"}}</span></div>'
                }, {
                    field: 'operate',
                    displayName: '操作',
                    minWidth: 100,
