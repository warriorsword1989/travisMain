/**
 * Created by wuzhen on 2016/12/20.
 */

angular.module('app').controller('engNameMainCtrl', ['$scope', 'ngDialog', '$ocLazyLoad',
    ...
    function ($scope, ngDialog, $ocLazyLoad, appPath, dsColumn, dsEdit, $interval, $cookies, $timeout) {
        ...
        $ocLazyLoad.load('./colEditor/ml/engName/engNameCtrl.js').then(function () {
            $scope.taskListUrl = './colEditor/ml/engName/engNameTpl.html';
        });
