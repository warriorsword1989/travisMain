...
angular.module('app').controller('engAddressMainCtrl', ['$scope', 'ngDialog', '$ocLazyLoad',
    ...
    function ($scope, ngDialog, $ocLazyLoad, appPath, dsColumn, dsEdit, $interval, $cookies, $timeout) {
        ...
        $ocLazyLoad.load('./colEditor/ml/engAddress/engAddressCtrl.js').then(function () {
            $scope.taskListUrl = './colEditor/ml/engAddress/engAddressTpl.html';
        });
