/**
 * Created by wuzhen on 2016/12/23.
 */
...
angular.module('app').controller('engAddressEditCtrl', ['$scope', 'NgTableParams', 'ngTableEventsChannel', '$sce', 'dsColumn', 'ngDialog', 'dsLazyload', 'appPath', 'hotkeys',
    function ($scope, NgTableParams, ngTableEventsChannel, $sce, dsColumn, ngDialog, dsLazyload, appPath, hotkeys) {
      ...
      /**
       *templateAddressChiCombine
       * @return {String} <div><div/>
       */
        function templateAddressChiCombine() {
            var html = '<div ng-bind-html="grid.appScope.getAddressChiCombine(row.entity)"></div>';
            return html;
        }
      ...
      /**
       *templateAddrEngFullname
       * @return {String} <div><div/>
       */
        function templateAddrEngFullname() {
      ...
      /**
       *templateEngShortLength
       * @return {String} <div><div/>
       */
        function templateEngShortLength() {
       ...
       */
        ...
        $scope.showDetail = function (row) {
            $scope.viewOjbect = {
                ...
                pinyin: row.addressChi.fullnamePhonetic
            };
        ...
        var conbineCols = function () {
            ...
            var engNameCols = {
                ...
                primaryCols: [
                    ...
                    { field: 'addressChi.fullname', displayName: '地址全称', enableSorting: true, cellTemplate: templateFullname, minWidth: 180 }
                ],
                // 重要分类地址英文作业 addressChi.fullname
                engMapAddress: [
                    { field: 'addressChi.name', displayName: '中文地址合并', enableSorting: true, cellTemplate: templateAddressChiCombine, width: 180 },
                    { field: 'addressEng.fullname', displayName: '英文地址全称', enableSorting: true, cellTemplate: templateAddrEngFullname, minWidth: 180 },
                    ...
                    { field: 'addressEng.shortname', displayName: '英文地址简称', enableSorting: true, cellTemplate: templateShortName, minWidth: 120, width: 120 },
                    { field: 'addressEng', displayName: '字符数2', enableSorting: false, cellTemplate: templateEngShortLength, width: 70, minWidth: 70, maxWidth: 80 },
                    { field: 'addressList', displayName: '参考信息', enableSorting: true, cellTemplate: templateNameList, minWidth: 80, width: 130 }
                ],
                // 非重要分类地址英文超长作业
                nonImportantLongEngAddress: [
                    { field: 'addressChi', displayName: '中文地址合并', enableSorting: true, cellTemplate: templateAddressChiCombine, width: 180 },
                    { field: 'addressEng.fullname', displayName: '英文地址全称', enableSorting: true, cellTemplate: templateAddrEngFullname, minWidth: 180 },
                    { field: 'addressEng.fullname', displayName: '字符数', enableSorting: false, cellTemplate: templateEngFullnameLength, width: 70, minWidth: 70, maxWidth: 80 },
                    { field: 'addressList', displayName: '参考信息', enableSorting: true, cellTemplate: templateNameList, minWidth: 80, width: 130 }
                ],
                // 后公共列
                lastCols: [
       ...
       */
        ...
        $scope.doSave = function () {
            // 重要分类地址英文作业特殊处理
            if ($scope.main.selectedItem.id === 'engMapAddress') { // 如果有简称需要将简称保存到fullname字段
                for (var i = 0; i < $scope.currentEdited.length; i++) {
