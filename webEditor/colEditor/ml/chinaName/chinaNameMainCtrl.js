...
angular.module('app').controller('chinaNameMainCtrl', ['$scope', 'ngDialog', '$ocLazyLoad',
    ...
    function ($scope, ngDialog, $ocLazyLoad, appPath, dsColumn, dsEdit, $interval, $cookies, $timeout) {
        ...
        $ocLazyLoad.load('./colEditor/ml/chinaName/chinaNameCtrl.js').then(function () {
            $scope.taskListUrl = './colEditor/ml/chinaName/chinaNameTpl.html';
        });
