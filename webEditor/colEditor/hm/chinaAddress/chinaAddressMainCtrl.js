...
angular.module('app').controller('hmChinaAddressMainCtrl', ['$scope', 'ngDialog', '$ocLazyLoad',
    ...
    function ($scope, ngDialog, $ocLazyLoad, appPath, dsColumn, dsEdit, $interval, $timeout, $cookies) {
        ...
        $ocLazyLoad.load('./colEditor/hm/chinaAddress/chinaAddressCtrl.js').then(function () {
            $scope.taskListUrl = './colEditor/hm/chinaAddress/chinaAddressTpl.html';
        });
