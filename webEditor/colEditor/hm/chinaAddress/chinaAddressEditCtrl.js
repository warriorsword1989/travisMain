...
angular.module('app').controller('hmChinaAddressEditCtrl', ['$scope', '$sce', 'dsColumn', 'ngDialog', 'dsLazyload', 'appPath', 'hotkeys',
    function ($scope, $sce, dsColumn, ngDialog, dsLazyload, appPath, hotkeys) {
       ...
       */
        function get11Name() {
            var html = '<div>{{row.entity.name11Cht.name}}</div>';
            return html;
        }
      /**
       * 获取全称
       ...
       */
        function getFullname() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>{{row.entity.addressCht.fullname}}</div>";
            return html;
        }
      /**
       * 获取进度
       ...
       */
        function getProvince() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.province' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.province}}</div></div>";
            return html;
        }
      /**
       * 获取城市
       ...
       */
        function getCity() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.city' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.city}}</div></div>";
            return html;
        }
      /**
       * 获取国家
       ...
       */
        function getCounty() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.county' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.county}}</div></div>";
            return html;
        }
      /**
       * 获取城镇
       ...
       */
        function getTown() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.town' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.town}}</div></div>";
            return html;
        }
      /**
       * 获取地点
       ...
       */
        function getPlace() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.place' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.place}}</div></div>";
            return html;
        }
      /**
       * 获取街道
       ...
       */
        function getStreet() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.street' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.street}}</div></div>";
            return html;
        }
      /**
       * 获取界标
       ...
       */
        function getLandmark() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.landmark' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.landmark}}</div></div>";
            return html;
        }
      /**
       * 获取前缀
       ...
       */
        function getPrefix() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.prefix' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.prefix}}</div></div>";
            return html;
        }
      /**
       * 获取房屋数量
       ...
       */
        function getHousenum() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.housenum' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.housenum}}</div></div>";
            return html;
        }
      /**
       * 获取type
       ...
       */
        function getType() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.type' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.type}}</div></div>";
            return html;
        }
      /**
       * 获取subnum
       ...
       */
        function getSubnum() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.subnum' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.subnum}}</div></div>";
            return html;
        }
      /**
       * 获取surfix
       ...
       */
        function getSurfix() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.surfix' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.surfix}}</div></div>";
            return html;
        }
      /**
       * 获取Estab
       ...
       */
        function getEstab() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.estab' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.estab}}</div></div>";
            return html;
        }
      /**
       * 获取building
       ...
       */
        function getBuilding() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.building' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.building}}</div></div>";
            return html;
        }
      /**
       * 获取Unit
       ...
       */
        function getUnit() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.unit' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.unit}}</div></div>";
            return html;
        }
      /**
       * 获取floor
       ...
       */
        function getFloor() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.floor' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.floor}}</div></div>";
            return html;
        }
      /**
       * 获取room
       ...
       */
        function getRoom() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.room' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.room}}</div></div>";
            return html;
        }
      /**
       * 获取addons
       ...
       */
        function getAddons() {
            var html = "<div class='ui-grid-cell-contents ui-grid-cell-contents-input'>" +
                ...
                " ng-model='row.entity.addressCht.addons' tabindex='-1'" +
                " class='editTableColumn mousetrap' contenteditable='true'>{{row.entity.addressCht.addons}}</div></div>";
            return html;
        }
        ...
        $scope.updateContent = function (event, row, prop) {
            ...
            if (row.entity.addressCht[prop] !== str) {
                row.entity.addressCht[prop] = str;
       ...
       */
        ...
        $scope.getNameList = function (row) {
            var html = '';
            var value = row.addressList;
            for (var i = 0; i < value.length; i++) {
                if (value[i].split('&')[2]) {
                    html += i + 1 + '.' + value[i].split('&')[0] + ' 字段存在不可存在汉字"' + value[i].split('&')[1] + '",建议改成"' + value[i].split('&')[2] + '";<br>';
                } else {
                    html += i + 1 + '.' + value[i].split('&')[0] + ' 字段存在不可存在汉字"' + value[i].split('&')[1] + '",建议改成无对应，请找相关技术人员确认;<br>';
                }
            }
            return html;
        };
        ...
        var chinaNameCols = {
            ...
            addrSplit: [
                // { field: 'name11Cht.name', displayName: '官方标准中文名称', enableSorting: true, cellTemplate: get11Name, minWidth: 130 }, // bug改善
                { field: 'addressCht.fullname', displayName: '地址全称', enableSorting: true, cellTemplate: getFullname, minWidth: 180 },
                { field: 'addressCht.province', displayName: '省名', enableSorting: true, cellTemplate: getProvince, minWidth: 70 },
                { field: 'addressCht.city', displayName: '市名', enableSorting: true, cellTemplate: getCity, minWidth: 70 },
                { field: 'addressCht.county', displayName: '区县名', enableSorting: true, cellTemplate: getCounty, minWidth: 70 },
                { field: 'addressCht.town', displayName: '乡镇街道办', enableSorting: true, cellTemplate: getTown, minWidth: 90 },
                { field: 'addressCht.place', displayName: '地名小区名', enableSorting: true, cellTemplate: getPlace, minWidth: 100 },
                { field: 'addressCht.street', displayName: '街巷名', enableSorting: true, cellTemplate: getStreet, minWidth: 90 },
                { field: 'addressCht.landmark', displayName: '标志物名', enableSorting: true, cellTemplate: getLandmark, minWidth: 80 },
                { field: 'addressCht.prefix', displayName: '前缀', enableSorting: true, cellTemplate: getPrefix, minWidth: 60 },
                { field: 'addressCht.housenum', displayName: '门牌号', enableSorting: true, cellTemplate: getHousenum, minWidth: 60 },
                { field: 'addressCht.type', displayName: '类型名', enableSorting: true, cellTemplate: getType, minWidth: 60 },
                { field: 'addressCht.subnum', displayName: '子号', enableSorting: true, cellTemplate: getSubnum, minWidth: 90 },
                { field: 'addressCht.surfix', displayName: '后缀', enableSorting: true, cellTemplate: getSurfix, minWidth: 60 },
                { field: 'addressCht.estab', displayName: '附属设施名', enableSorting: true, cellTemplate: getEstab, minWidth: 100 },
                { field: 'addressCht.building', displayName: '楼栋号', enableSorting: true, cellTemplate: getBuilding, minWidth: 60 },
                { field: 'addressCht.unit', displayName: '楼门号', enableSorting: true, cellTemplate: getUnit, minWidth: 60 },
                { field: 'addressCht.floor', displayName: '楼层', enableSorting: true, cellTemplate: getFloor, minWidth: 60 },
                { field: 'addressCht.room', displayName: '房间号', enableSorting: true, cellTemplate: getRoom, minWidth: 60 },
                { field: 'addressCht.addons', displayName: '附加信息', enableSorting: true, cellTemplate: getAddons, visible: true, minWidth: 100 },
            ...
            addrPinyin: [
                ...
                // { field: 'name11Cht.name', displayName: '官方标准中文名称', enableSorting: true, cellTemplate: get11Name, visible: true, minWidth: 160 }, // bug改善
                { field: 'addressCht.roadnameStr', displayName: '中文地址合并', enableSorting: true, cellTemplate: $scope.formatCombineName, visible: true, minWidth: 300 },
                { field: 'addressCht.roadnamePhoneticStr', displayName: '拼音地址合并', cellTemplate: $scope.formatCombinePinyin, visible: true, minWidth: 300 },
       ...
       */
        ...
        var specialProcess = function () {
            ...
            if ($scope.main.workType === 'addrPinyin') { // 对地址拼音的特殊处理
                for (i = 0; i < $scope.currentEdited.length; i++) {
                    var temp = $scope.currentEdited[i].addressCht;
            ...
            for (var j = 0; j < $scope.currentEdited.length; j++) {
                for (var z = 0; z < addArr.length; z++) {
                    if ($scope.currentEdited[j].addressCht[addArr[z]]) {
                        $scope.currentEdited[j].addressCht[addArr[z]] = $scope.currentEdited[j].addressCht[addArr[z]].replace(/[\\|\\｜]/g, '');
                    }
                }
            }
        };
        ...
        $scope.doReplace = function () {
            ...
            if ($scope.searchObject.searchType) {
                var name = currentData.addressCht[$scope.searchObject.searchType]; // 18个字段
                if (searchText) {
                    if ((name && name.indexOf(searchTextDbc) > -1) || (name && name.indexOf(searchTextCbd) > -1)) {
                        ...
                        currentData.addressCht[$scope.searchObject.searchType] = finalyValue;
                    }
                } else {
                    if (!name) {
                        currentData.addressCht[$scope.searchObject.searchType] = replaceVal;
                    }
                }
            }
        ...
        $scope.doReplaceAll = function () {
            ...
            for (var i = 0; i < $scope.currentEdited.length; i++) {
                ...
                if ($scope.searchObject.searchType) {
                    var name = temp.addressCht[$scope.searchObject.searchType]; // 18个字段
                    if (searchText) {
                        if ((name && name.indexOf(searchTextDbc) > -1) || (name && name.indexOf(searchTextCbd) > -1)) {
                            count += 1;
                            var finalyValue = name.split(searchTextDbc).join(replaceVal);
                            ...
                            temp.addressCht[$scope.searchObject.searchType] = finalyValue;
                        }
                    } else {
                        if (!name) {
                            count += 1;
                            temp.addressCht[$scope.searchObject.searchType] = replaceVal;
                        }
                    }
                }
            }
                    ...
                    for (var i = 0; i < $scope.currentEdited.length; i++) {
                        if ($scope.currentEdited[i].pid === row.entity.pid) {
                            ...
                            if (currentReplaceIndex < $scope.currentEdited.length) {
                                $scope.currentEdited[currentReplaceIndex].addressCht[attr] = row.entity.addressCht[attr];
